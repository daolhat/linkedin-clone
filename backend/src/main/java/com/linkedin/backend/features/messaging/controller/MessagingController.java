...
public class MessagingController {
    ...
    public Conversation getConversations(@RequestAttribute("authenticatedUser") AuthenticationUser user,
    ...
    public Response addMessageToConversation(@RequestAttribute("authenticatedUser") AuthenticationUser user,
