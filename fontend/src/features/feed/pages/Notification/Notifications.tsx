...
function Notification({
    ...
    return (
        <button
            ...
            className={notification.read ? classes.notification : `${classes.notification} ${classes.unread}`}
        >
            ...
            <p style={{ marginRight: "auto", }}>
                ...
                {notification.type === NotificationType.LIKE ? "liked" : "commneted on"} your post.
            </p>
